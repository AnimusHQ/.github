<p align="center">
  <a href="https://kapakka.org">
    <img src="https://raw.githubusercontent.com/AnimusHQ/.github/main/assets/animus-banner.png" alt="Animus — open-source engineering crew for secure infrastructure, resilient control planes, developer tools, automation, and AI-readable systems" width="100%" />
  </a>
</p>
...
<p align="center">
  ...
  ·
  <a href="https://t.me/animus_link_bot">Animus Link Access</a>
  ·
  <a href="#start-here">Start Here</a>
  ·
  <a href="#projects-and-directions">Projects</a>
  ·
...
### Educational and Community Media
...
| `Active Development` | Maintained project moving toward stable use. |
| `Live Beta` | Used by a real early community with active iteration and clear limitations. |
| `Production Track` | Designed with production operations, security, documentation, and release discipline in mind. |
| `Archived` | Historical work kept for reference, with no active maintenance unless stated otherwise. |
...
<p align="center">
  <sub>Animus — secure infrastructure, resilient control planes, open-source product foundations, and AI-readable engineering knowledge.</sub>
</p>
